/** Test-only historical lab import contract; never loaded by the application. */
import type { ReconstructionLabResult } from '../../src/lib/reconstruction/lab';
import type { ProjectDocument } from '../../src/lib/types';
import type { LegacyRepositories } from './legacy-local-repositories';
...
export { readLabProjectReport, type LabProjectBundle } from '../../src/lib/reconstruction/lab-project';
...
export async function saveLabResultAsProject(
  ...
  options: { name?: string; repositories: Omit<LegacyRepositories, 'mode'> & { mode: string }; signal?: AbortSignal },
